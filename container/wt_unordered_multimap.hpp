#ifndef _STL_WT_UNORDERED_MULTIMAP_HPP_
#define _STL_WT_UNORDERED_MULTIMAP_HPP_
...
public:
    ...
    unordered_multimap() 
    : unordered_multimap(wt_default_bucket_count()) 
    { }

    explicit unordered_multimap(size_type _bcount,
    ...
    unordered_multimap(size_type _bcount, const allocator_type& _alloc)
    : m_impl_(_bcount, hasher(), key_equal(), _alloc) 
    { }

    unordered_multimap(size_type _bcount, const hasher& _hash, 
                       const allocator_type& _alloc)
    : m_impl_(_bcount, _hash, key_equal(), _alloc) 
    { }

    explicit unordered_multimap(const allocator_type& _alloc)
    : m_impl_(wt_default_bucket_count(), hasher(), key_equal(), _alloc) 
    { }

    template <typename InputIter>
    unordered_multimap(InputIter _first, InputIter _last,
    ...
    unordered_multimap(const unordered_multimap& other, const allocator_type& _alloc)
    : m_impl_(other.m_impl_, _alloc)
    { }

    // TODO: unordered_multimap(unordered_multimap&&)
    ...
    // TODO: operator=(unordered_multimap&&)
    ...
    friend bool operator==(const unordered_multimap<_K, _T, _H, _KE, _A>& lhs,
                           const unordered_multimap<_K, _T, _H, _KE, _A>& rhs);
private:
    _Impl_type      m_impl_;
};
...
template <typename Key, typename T, typename Hash,
          typename KeyEqual, typename Allocator>
bool
operator==(const unordered_multimap<Key, T, Hash, KeyEqual, Allocator>& lhs,
...
template <typename Key, typename T, typename Hash,
          typename KeyEqual, typename Allocator>
void
swap(const unordered_multimap<Key, T, Hash, KeyEqual, Allocator>& lhs,
     const unordered_multimap<Key, T, Hash, KeyEqual, Allocator>& rhs)
{
    lhs.swap(rhs);
}
